...
public interface InvitationService {
    ...
    ru.sicampus.bootcamp2026.dto.response.InvitationResponseDTO createInvitation(InvitationCreateDTO dto) throws InvitationException, MeetingException, UserNotFoundException;
    void replyToInvitation(long id, InvitationAnswerDTO dto) throws InvitationException;
